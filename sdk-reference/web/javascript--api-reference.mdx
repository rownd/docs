...
2. Automatically sign in a user using their email
...
3. Prompt the user to sign in with Google and save a referral code to their user data
```javascript
rownd.requestSignIn({
  method: 'google',
  user_data: {
...
1. Prompt the user to enter their first and last name
