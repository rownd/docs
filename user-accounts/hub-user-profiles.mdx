...
The Rownd Hub will be displayed in the bottom left corner of your desktop app or website upon installation. Initially, it will not appear on your mobile app. The hub showcases a black outline user icon for unsigned users and a filled user icon for signed users. By clicking on the top user icon, users can sign in and access their profile information. Once signed in, they can view and manage their profile data by selecting "Full account controls."

The design styles set in the "Design" tab will be reflected in the appearance of the hub and profile. If you wish to remove the hub, please reach out to us at support@rownd.io.
