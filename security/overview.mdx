...
### Prevent fake users, phishing, and breaches
...
| Passwordless Methods | Breached passwords | Passwordless means no breached passwords. |
| [Domain Allow-listing](/security/attack-mitigation/domain-allow-list) | Site-jacking | Rownd allows users to add domains that should be authenticated from, providing an extra layer of security. |
