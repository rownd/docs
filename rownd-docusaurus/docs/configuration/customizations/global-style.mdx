...
<div style={{ position: 'relative', paddingBottom: '63.829787234042556%', height: '0' }}><iframe src="https://www.loom.com/embed/68480fce8a8b4af48c11a2906bf58181" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%'}}></iframe></div>
