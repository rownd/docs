...
sidebarTitle: "Overview for NEAR integration"
...
- **Automatic wallet creation**<br />
   ...
   <Tabs>
      <Tab title="Mobile" value="mobile-prof-wallet">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/profile-with-wallet.png" />
        </Frame>
      </Tab>
      <Tab title="Desktop" value="desktop-prof-wallet">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/desktop/profile-with-wallet.png" />
        </Frame>
      </Tab>
   </Tabs>
...
- **On-Demand wallet creation**<br />
   ...
   <Tabs>
      <Tab title="Mobile" value="mobile-on-demand">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-wallet-details.png" />
        </Frame>
      </Tab>
      <Tab title="Desktop" value="desktop-on-demand">
        <Frame>
...
- **User wallet access**<br />
   ...
   <Tabs>
      <Tab title="Mobile" value="mobile-access">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-wallet-details.png" />
        </Frame>
      </Tab>
      <Tab title="Desktop" value="desktop-access">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/desktop/near-wallet-details.png" />
        </Frame>
      </Tab>
...
- **Easy wallet attachment**<br />
   ...
   <Tabs>
      <Tab title="Mobile" value="mobile-attach">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-connect-account.png" />
        </Frame>
      </Tab>
      <Tab title="Desktop" value="desktop-attach">
        <Frame>
...
<ParamField path="near_personal_account_id" type="string">
  The personal NEAR account ID
</ParamField>
<ParamField path="near_personal_wallet_id" type="string">
