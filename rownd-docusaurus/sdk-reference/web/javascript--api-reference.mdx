...
<ResponseField name="manageAccount()" type="Function">
  ...
  <Tabs values={[{label: 'Mobile', value: 'mobile'}, {label: 'Desktop', value: 'desktop'}]}>
...
```
<Tabs values={[{label: 'Mobile', value: 'mobile-req'}, {label: 'Desktop', value: 'desktop-req'}]}>
  <TabItem value="mobile-req">
    <Frame>
      <img style={{height:'400px'}} src="/images/hub/mobile/request-fields.png" />
    </Frame>
  </TabItem>
  <TabItem value="desktop-req">
    <Frame>
...
<ResponseField name="near" type="object">
  ...
  <ResponseField name="createNamedAccount()" type="function">
    ...
    <Tabs values={[{label: 'Mobile', value: 'mobile-named'}, {label: 'Desktop', value: 'desktop-named'}]}>
      <TabItem value="mobile-named">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-create-named-account.png" />
        </Frame>
      </TabItem>
      <TabItem value="desktop-named">
        <Frame>
  ...
  <ResponseField name="connectAccount()" type="function">
    ...
    <Tabs values={[{label: 'Mobile', value: 'mobile-conn'}, {label: 'Desktop', value: 'desktop-conn'}]}>
      <TabItem value="mobile-conn">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-connect-account.png" />
        </Frame>
      </TabItem>
      <TabItem value="desktop-conn">
        <Frame>
  ...
  <ResponseField name="walletDetails()" type="function">
    ...
    <Tabs values={[{label: 'Mobile', value: 'mobile-wallet'}, {label: 'Desktop', value: 'desktop-wallet'}]}>
      <TabItem value="mobile-wallet">
        <Frame>
          <img style={{height:'400px'}} src="/images/hub/mobile/near-wallet-details.png" />
        </Frame>
      </TabItem>
      <TabItem value="desktop-wallet">
        <Frame>
