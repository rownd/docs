...
4.  Click the **Begin authentication** button and sign in to your Google Account to grant Rownd access to your Firebase project.
...
5.  Select the Firebase Project, Application, and Database that you'd like to link with Rownd.
