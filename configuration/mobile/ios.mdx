---
title: "Mobile iOS configuration"
sidebarTitle: "iOS"
description: "Configure iOS apps in Rownd with ease."
---

Configure for mobile iOS devices including ([React Native](/sdk-reference/mobile/react-native), [Flutter](/sdk-reference/mobile/flutter), and [iOS](/sdk-reference/mobile/ios)). Universal links are required to complete the Email/Phone sign in flow.
