...
Configure Rownd for Android mobile devices including ([React Native](/sdk-reference/mobile/react-native) and [Flutter](/sdk-reference/mobile/flutter)). Universal links are required to complete the email/phone sign in flow.
