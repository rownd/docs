...
2. Select "OIDC Configuration" from the menu
3. Click "Create New OIDC Client"
4. Fill out the configuration form:

#### Required Fields
- **Name**: A display name for your OIDC client (required)
- **Allowed Origins**: The domains that are allowed to make requests to the OIDC server (required). You can add more than one. 
...
- **Post Logout URIs**: Where users will be redirected after logging out
  - Example: `https://example.com/logout`
- **Logo URI**: URL to your logo image for light mode
- **Dark Mode Logo URI**: URL to your logo image for dark mode
