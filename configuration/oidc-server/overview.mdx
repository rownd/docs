...
1. [Setup Using the Platform](#using-the-rownd-platform)
...
By default, OIDC authentication flows direct users to a Rownd-hosted URL for sign-in. However, if you have Rownd integrated into your website or application, you can provide a custom interaction endpoint for a more streamlined experience.
...
<Note>
The interaction endpoint must be a page where Rownd is properly installed and configured. This ensures the authentication flow can properly handle the OIDC consent process.
</Note>
