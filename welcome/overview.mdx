...
---
## Start Building
### Choose your applicaiton type to get started
...
<CardGroup>
  ...
  <Card
    ...
    Webapp that runs in a browser (React, Next.js, Vue, etc)
  </Card>
  <Card
    title="Website"
    icon="browser" 
...
Rownd is a powerful and comprehensive authentication platform designed to streamline user sign-in processes, boost sign-in rates, and provide a secure user experience. Rownd offers a variety of sign-in methods, adaptive authentication, robust security features, automations, and SDKs for easy integration with various platforms.

By leveraging Rownd's features, app and website creators can provide a tailored sign-up experience to their users, leading to higher engagement and retention. Rownd's user management system allows users to link multiple authentication methods to a single account, preventing duplicate accounts and ensuring a consistent experience across different sign-in options.
