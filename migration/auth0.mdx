...
Rownd supports multiple ways to sync your user data from Auth0. Once the Auth0 integration is created and attached to your app, Rownd will begin migrating users "just in time," meaning that as users sign in, their data will automatically be imported into Rownd (matched on email address, phone number, etc).
