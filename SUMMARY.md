...
* [🎛 Configuration](guides/configuration/README.md)
  ...
  * [Authentication Methods](guides/configuration/authentication-methods/README.md)
    * [Email Sign-in](guides/configuration/authentication-methods/email-sign-in.md)
  ...
  * [Customizations](guides/configuration/customizations/README.md)
    ...
    * [Email customization](guides/configuration/customizations/email-customization.md)
  ...
  * [🔌 Integrations](guides/configuration/integrations/README.md)
    * [Airtable](guides/configuration/integrations/airtable.md)
    * [Firebase - Realtime Database](guides/configuration/integrations/firebase-realtime-database/README.md)
      * [Google Cloud Platform requirements](guides/configuration/integrations/firebase-realtime-database/google-cloud-platform-requirements.md)
      * [Examples: Defining user data locations](guides/configuration/integrations/firebase-realtime-database/examples-defining-user-data-locations.md)
    * [Webhooks](guides/configuration/integrations/webhooks.md)
